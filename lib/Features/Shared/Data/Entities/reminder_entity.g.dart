...
void _reminderSerialize(
  ...
  writer.writeLong(offsets[0], object.minutesBefore);
...
Reminder _reminderDeserialize(
  ...
  object.minutesBefore = reader.readLong(offsets[0]);
...
extension ReminderQueryFilter
  ...
  QueryBuilder<Reminder, Reminder, QAfterFilterCondition> minutesBeforeEqualTo(
      int value) {
  ...
  QueryBuilder<Reminder, Reminder, QAfterFilterCondition> minutesBeforeLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Reminder, Reminder, QAfterFilterCondition> minutesBeforeBetween(
    int lower,
    int upper, {
